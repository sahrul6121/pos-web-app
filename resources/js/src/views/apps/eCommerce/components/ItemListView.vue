        ...
        <template slot="no-body">
            <div class="vx-row item-details no-gutter">
                ...
                <div class="vx-col sm:w-1/4 w-full item-img-container bg-white flex items-center justify-center cursor-pointer">
                    <img :src="item.product_image" :alt="item.product_name" class="grid-view-img p-4">
                </div>
                ...
                <div class="vx-col sm:w-1/2">
                    <div class="p-4 pt-6">
                        <slot name="item-meta">
                            <h6 class="item-name font-semibold mb-1 hover:text-primary cursor-pointer">{{ item.product_name }}</h6>
                            <p class="text-sm mb-4">By <span class="font-semibold cursor-pointer">{{ item.store_name }}</span></p>
                        </slot>
                    </div>
                </div>
                ...
                <div class="vx-col sm:w-1/4 w-full flex items-center sm:border border-0 border-solid d-theme-border-grey-light border-r-0 border-t-0 border-b-0">
                    ...
                    <div class="p-4 flex flex-col w-full">
                        <div class="my-6">
                            <h5 class="font-bold text-center">{{ item.product_price }}</h5>
                        </div>
